...
const AddNewPaletteModal = ({ navigation }) => {
  ...
  const handleSubmit = useCallback(() => {
    if (!paletteName) {
      ...
      navigation.navigate('Home', { newPallette });
    }
  ...
  const handleValueChange = useCallback(
    (value, color) => {
      if (value === true) {
        setSelectedColors((currentColorsSelected) => [
          ...currentColorsSelected,
          color,
        ]);
      } else {
        setSelectedColors((currentColorsSelected) =>
          currentColorsSelected.filter(
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.text}>Enter the name of the palette</Text>
      <TextInput
        style={styles.textInput}
        placeholder="Enter color pallette name here"
        value={paletteName}
      ...
      <FlatList
        ...
        renderItem={(item) => colorSelector(item)}
      />
      {/* <View style={styles.color}>
