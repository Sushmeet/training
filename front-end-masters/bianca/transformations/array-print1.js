...
[
  ...
  { name: 'Col. Mustard', color: 'Mustard', speak: [Function: speak] },
  { name: 'Mrs White', color: 'White', speak: [Function: speak] }
]
*/

// what if we just use map to do this 

const suspectListLoop2 = suspectNames.map(name => createSuspect(name))
console.log('sushpectListLoop2---', suspectListLoop2);
